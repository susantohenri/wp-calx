...
add_shortcode('calx', function () {
	...
	wp_register_script('calx', plugin_dir_url(__FILE__) . 'jquery-calx-2.2.8.min.js', ['jquery', 'moment']);
	wp_enqueue_script('calx');

	wp_register_script('calx-init', plugin_dir_url(__FILE__) . 'jquery-calx-init.js', ['jquery'], 3);
